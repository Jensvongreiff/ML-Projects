...
def vocab(full_data, multidata=False):  # takes in a list[list[list]] if multidata = True, otherwise list[list] of
    ...
    vocabulary, counts = zip(
        *Counter(flattened_data).most_common(200))  # sorts vocab and counts by 200 most commonly occurring
